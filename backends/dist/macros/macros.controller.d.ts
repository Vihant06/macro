...
export declare class MacrosController {
    ...
    getTodayTotals(userId: string, date?: string): Promise<{
        date: string;
        goals: {
            calories: number;
            protein: number;
    ...
    getWeeklySummary(userId: string, endDate?: string): Promise<{
        startDate: string;
        endDate: string;
        daysTracked: number;
        weeklyTotals: any;
    ...
    getMacroDistribution(userId: string, date?: string): Promise<{
        date: string;
