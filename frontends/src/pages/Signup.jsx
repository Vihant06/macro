  ...
  return (
    <div style={{ padding: '2rem', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: '28rem', margin: '0 auto' }}>
      ...
      <div className="glass-card rounded-custom shadow-premium" style={{ padding: '2.5rem' }}>
        <h2 className="font-manrope font-bold text-2xl mb-2">Create Account</h2>
        <p className="font-inter" style={{ color: '#71717a', fontSize: '0.875rem', marginBottom: '2rem' }}>Start your precision fitness journey.</p>
        
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <label className="font-inter font-semibold" style={{ fontSize: '0.7rem', textTransform: 'uppercase', letterSpacing: '0.08em', color: '#71717a' }}>Full Name</label>
            <input 
              id="signup-name"
              type="text" 
              style={{ padding: '0.875rem 1rem', border: '1px solid var(--outline-variant)', borderRadius: '0.75rem', outline: 'none', background: 'rgba(255,255,255,0.6)', fontSize: '0.9375rem' }}
